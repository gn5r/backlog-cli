...
import { issueIdOrKeyOption, type IssueIdOrKeyOption } from "@/options/issue/issueIdOrKeyOption";
...
export class GetIssue extends AbstractSubCommand<unknown, IssueIdOrKeyOption> {
  ...
  public builder: CommandBuilder<unknown, IssueIdOrKeyOption> = (yargs) =>
    yargs.options(issueIdOrKeyOption).parserConfiguration({ "camel-case-expansion": false });
